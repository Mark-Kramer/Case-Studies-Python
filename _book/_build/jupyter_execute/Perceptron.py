...
This discussion follows the excellent example and discussion at <a href="https://natureofcode.com/book/chapter-10-neural-networks/" rel="external">The Nature of Code</a>. Please see that reference for additional details, and a more sophisticated coding strategy (using Classes in Python).
